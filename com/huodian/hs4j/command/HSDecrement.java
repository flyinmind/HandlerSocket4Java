...
public class HSDecrement extends HSModify {
	public HSDecrement() {
		this(CompareOperator.GE, new String[] {""}, null);
	}

	public HSDecrement(CompareOperator operator, String[] conditions, String[] values) {
		super(HSProto.OPERATOR_DECREMENT, operator, conditions, values);
	}
}